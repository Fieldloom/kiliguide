...
export function DeptWorkspace() {
  ...
  const handleDeleteAccount = async () => {
    const confirmDelete = window.confirm(
      "Are you sure you want to PERMANENTLY DELETE your department admin account? All your personal settings and profile data will be erased. This action CANNOT be undone."
    );
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <span style={{ display: "block", fontSize: 10, color: "#a1a1aa", marginTop: 1 }}>Department Portal</span>
            </div>
          </div>
          {mobileSidebar && (
      ...
      <div style={{ padding: "12px", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 8, background: "rgba(0,0,0,0.3)" }}>
        <button onClick={() => switchTab("Profile")} style={{ flex: 1, display: "flex", alignItems: "center", gap: 10, background: "transparent", border: "none", cursor: "pointer", padding: "4px", borderRadius: 8, textAlign: "left", minWidth: 0 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <span style={{ display: "block", fontSize: 10, color: "#a1a1aa", textOverflow: "ellipsis", overflow: "hidden", whiteSpace: "nowrap" }}>Dept Account</span>
          </div>
        </button>
        ...
        <header className="desktop-only" style={{ margin: "20px 28px 0", padding: "12px 24px", height: 70, display: "flex", alignItems: "center", justifyContent: "space-between", background: "linear-gradient(135deg, rgba(20, 26, 36, 0.85) 0%, rgba(12, 17, 24, 0.75) 100%)", backdropFilter: "blur(28px) saturate(190%)", WebkitBackdropFilter: "blur(28px) saturate(190%)", borderRadius: 22, border: "1px solid rgba(255, 255, 255, 0.12)", boxShadow: "0 20px 50px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 0 30px rgba(16, 185, 129, 0.04)", flexShrink: 0, zIndex: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "7px 16px", borderRadius: 14, background: "linear-gradient(135deg, rgba(255,255,255,0.07) 0%, rgba(255,255,255,0.02) 100%)", border: "1px solid rgba(255,255,255,0.12)", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.1)", fontSize: 13, fontWeight: 600, color: "#f4f4f5", letterSpacing: "-0.01em" }}>
              ...
              <span>Department Portal ({tab})</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <motion.button whileHover={{ scale: 1.05, backgroundColor: "rgba(255,255,255,0.08)" }} whileTap={{ scale: 0.95 }} onClick={()=>switchTab("Notices")} title="Notices" style={{ padding: 10, borderRadius: 14, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.12)", color: "#e4e4e7", cursor: "pointer", position: "relative", transition: "all 0.2s cubic-bezier(0.16, 1, 0.3, 1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Bell size={18} />
              {notices.length > 0 && <span style={{ position: "absolute", top: 8, right: 8, width: 8, height: 8, borderRadius: "50%", background: "#10b981", boxShadow: "0 0 10px #10b981" }} />}
            </motion.button>
            ...
            <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="desktop-only" style={{ padding: "28px 28px 100px", maxWidth: 1360, margin: "0 auto" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28 }}>
                <div>
                  <h1 style={{ fontSize: 28, fontWeight: 700, color: "#fff", letterSpacing: "-0.02em", marginBottom: 4 }}>
                    Welcome back, <span style={{ color: "#10b981" }}>{name.split(" ")[0]}</span> 🏛️
                  </h1>
                  <p style={{ color: "#a1a1aa", fontSize: 14 }}>{instShortName} Department Administration • Academic Year 2026/2027</p>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div className="glass-panel" style={{ padding: "8px 16px", borderRadius: 12, fontSize: 12, fontWeight: 600, color: "#10b981", display: "flex", alignItems: "center", gap: 8 }}>
                    <ShieldCheck size={16} /> Department Administrator
                  </div>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 24, alignItems: "start" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                  ...
                  <div className="glass-panel" style={{ padding: 32, border: "none", position: "relative", overflow: "hidden" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <h2 style={{ fontSize: 18, fontWeight: 700, color: "#fff" }}>Department AI Assistant & Policy Hub</h2>
                      </div>
                      <span style={{ fontSize: 11, color: "#a1a1aa", background: "rgba(255,255,255,0.05)", padding: "3px 8px", borderRadius: 6 }}>{instShortName} Admin Portal</span>
                    </div>
                    
                    <p style={{ color: "#a1a1aa", fontSize: 14, marginBottom: 20 }}>Search across departmental guidelines, student clearance procedures, document archives, and escalation workflows.</p>
                    ...
                    <div className="glass-input" style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 12px 10px 20px" }}>
                      ...
                      <input value={query} onChange={e => setQuery(e.target.value)} onKeyDown={e => { if (e.key === "Enter") ask(); }} placeholder="Ask about student clearance, departmental notices, document index..." style={{ flex: 1, background: "transparent", border: "none", outline: "none", fontSize: 14, color: "#fff" }} />
                      <motion.button onClick={() => ask()} disabled={!query.trim()} style={{ width: 38, height: 38, borderRadius: 12, display: "grid", placeItems: "center", border: "none", background: query.trim() ? "linear-gradient(135deg, #10b981 0%, #059669 100%)" : "rgba(255,255,255,0.08)", color: "#fff", cursor: query.trim() ? "pointer" : "not-allowed" }}>
                        <Send size={15} style={{ transform: "rotate(45deg)", marginLeft: -1 }} />
                      </motion.button>
                    </div>

                    {/* Quick Suggestions for Dept Staff */}
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 16 }}>
                      {[
                        "How to publish departmental notices?",
                        "Student clearance procedure steps",
                        "Escalation ticket resolution SLA",
                        "Course unit allocation rules"
                      ].map((promptText, pIdx) => (
                        <button
                          key={pIdx}
                  ...
                  {/* Quick Access Grid */}
                  <div>
                    <h3 style={{ fontSize: 13, fontWeight: 700, color: "#71717a", marginBottom: 14, letterSpacing: "0.06em", textTransform: "uppercase" }}>Department Workspaces</h3>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
                      
                      <motion.div whileHover={{ y: -3 }} onClick={() => ask("What are the rules for new Department Admins?")} className="glass-panel" style={{ padding: 20, cursor: "pointer", border: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", gap: 12 }}>
                        ...
                        <span style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}>Departmental Rules</span>
                        <span style={{ fontSize: 12, color: "#a1a1aa" }}>Admin policies & guidelines</span>
                      </motion.div>

                      <motion.div whileHover={{ y: -3 }} onClick={() => switchTab("Notices")} className="glass-panel" style={{ padding: 20, cursor: "pointer", border: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", gap: 12 }}>
                        ...
                        <span style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}>Broadcasting & Circulars</span>
                        <span style={{ fontSize: 12, color: "#a1a1aa" }}>Publish & manage student notices</span>
                      </motion.div>

                      <motion.div whileHover={{ y: -3 }} onClick={() => switchTab("Documents")} className="glass-panel" style={{ padding: 20, cursor: "pointer", border: "1px solid rgba(255,255,255,0.06)", display: "flex", flexDirection: "column", gap: 12 }}>
                        <div style={{ width: 40, height: 40, borderRadius: 12, background: "rgba(168, 85, 247, 0.15)", display: "grid", placeItems: "center" }}>
                          <FileText size={20} style={{ color: "#a855f7" }} />
                        </div>
                        <span style={{ fontSize: 15, fontWeight: 700, color: "#fff" }}>Document Ingestion</span>
                        <span style={{ fontSize: 12, color: "#a1a1aa" }}>Index new PDF statutes & notices</span>
                      </motion.div>
                  ...
                  <div className="glass-panel" style={{ padding: 22, border: "none" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        ...
                        <h3 style={{ fontSize: 14, fontWeight: 700, color: "#fff" }}>Department Notices</h3>
                      </div>
                      <span style={{ fontSize: 10, background: "rgba(16, 185, 129, 0.15)", color: "#10b981", padding: "2px 6px", borderRadius: 4, fontWeight: 700 }}>ADMIN</span>
                    </div>
                    ...
                    {notices.length > 0 ? (
                      <div>
                        ...
                        <button onClick={() => switchTab("Notices")} style={{ background: "transparent", border: "none", color: "#10b981", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Manage Circulars →</button>
                      </div>
                    ) : (
                      <p style={{ color: "#71717a", fontSize: 12 }}>No active notices.</p>
                    )}
                  </div>

                  {/* IT Support Ticket Hub */}
                  <div className="glass-panel" style={{ padding: 22, border: "none" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                      <Ticket size={18} style={{ color: "#10b981" }} />
                      <h3 style={{ fontSize: 14, fontWeight: 700, color: "#fff" }}>Student Escalations</h3>
                    </div>
                    ...
                    <div style={{ padding: "12px", borderRadius: 12, background: "rgba(16, 185, 129, 0.08)", border: "1px solid rgba(16, 185, 129, 0.2)", marginBottom: 14 }}>
                      <span style={{ fontSize: 11, color: "#10b981", fontWeight: 700, textTransform: "uppercase" }}>Escalation SLA</span>
                      <span style={{ fontSize: 13, fontWeight: 600, color: "#fff", display: "block", marginTop: 2 }}>
                        Verified Helpdesk Queue
                      </span>
                    </div>

                    <button onClick={() => switchTab("Support")} style={{ width: "100%", padding: "10px", borderRadius: 12, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", fontSize: 13, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                      View Support Desk <ChevronRight size={15} />
                    </button>
                  </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 sm:p-8 relative">
            <div className="max-w-6xl mx-auto pb-24">
              <AcademicResourcesModule
                ...
                userName={deptName || "Department Admin"}
              />
            </div>
          </div>
        ) : tab === "Documents" ? (
              ...
              <div className="flex flex-col gap-4">
                ...
                {notices.length === 0 && (
                  <div className="glass-panel p-8 sm:p-12 rounded-3xl border border-white/10 text-center bg-black/20">
                    ...
                    <p className="text-white font-bold text-base">No Department Notices</p>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "32px 24px", position: "relative" }}>
            <div style={{ maxWidth: 600, margin: "0 auto", paddingBottom: 100 }}>
              ...
              <div className="glass-panel" style={{ padding: 32, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
                ...
                <span style={{ fontSize: 12, color: "#10b981", background: "rgba(16, 185, 129, 0.1)", padding: "4px 12px", borderRadius: 100, fontWeight: 600, textTransform: "uppercase", border: "1px solid rgba(16,185,129,0.2)" }}>Department Admin Account</span>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "32px 24px", position: "relative" }}>
            <div style={{ maxWidth: 600, margin: "0 auto", paddingBottom: 100 }}>
              ...
              <div className="glass-panel" style={{ padding: 24, marginBottom: 24, border: "1px solid rgba(239, 68, 68, 0.2)" }}>
                ...
                <p style={{ color: "#a1a1aa", fontSize: 14, marginBottom: 20 }}>Sign out securely or permanently delete your department admin account.</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
