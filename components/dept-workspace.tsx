          ...
          <div style={{ flex: 1, overflowY: "auto", position: "relative" }} className="hide-scroll">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="desktop-only" style={{ padding: "40px 32px 100px", maxWidth: 1200, margin: "0 auto" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 16, marginBottom: 32 }}>
                {[
                  { l: "Academics", i: GraduationCap, t: "Registration & Units", d: "What are the rules for new Department Admins?" },
                  ...
                  { l: "Support", i: HeadphonesIcon, t: "IT & Helpdesk", d: "How do I connect to Department Admin WiFi?" }
                ].map((btn, i) => (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                ...
                <div>
                   ...
                   <div className="glass-panel" style={{ padding: 20, marginBottom: 16, display: "flex", alignItems: "center", gap: 16 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <b style={{ display: "block", color: "#fff", fontSize: 14 }}>Support Integration</b>
                        <span style={{ fontSize: 13, color: "#a1a1aa" }}>{timetables.length > 0 ? "Active and monitored." : "No timetable uploaded yet."}</span>
                      </div>
                      <button onClick={() => switchTab("Manage Tickets")} style={{ padding: "6px 12px", borderRadius: 12, background: "rgba(139, 92, 246, 0.1)", color: "#8b5cf6", border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>{timetables.length > 0 ? "View" : "Upload"}</button>
                   </div>
