    ...
    <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 100, padding: "0 24px", position: "relative", zIndex: 100 }}>
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <Link href="/login" onClick={() => setMobileMenuOpen(false)} style={{ padding: "12px 16px", color: "#ececec", textDecoration: "none", fontSize: 14, fontWeight: 600, borderRadius: 8, transition: "background 0.2s" }} onMouseEnter={e => e.currentTarget.style.background="rgba(255,255,255,0.05)"} onMouseLeave={e => e.currentTarget.style.background="transparent"}>
            App Workspaces
          </Link>
        </motion.div>
      )}
